...
def _p8_violations_total(protocol):
    ...
    Ревью 2026-07-04 H3: validate_p8 возвращает СПИСОК нарушений (agents.py кладёт его в
    p8_violations как есть) — прежний подсчёт `isinstance(v, int)` всегда давал 0, и gate
    §23.2(б) был слеп к фабрикации оснований. Считаем и списки, и легаси-int."""
    total = 0
